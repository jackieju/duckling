...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7905213445851217, unseen = -5.181783550292085,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 176},
                   koData =
                     ClassData{prior = -0.6044190649512611, unseen = -5.365976015021851,
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.8050650967639307, unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 38},
                   koData =
                     ClassData{prior = -0.5925036547802578, unseen = -4.770684624465665,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.3642786619993856),
                                    ("integer (0..19)year (grain)", -3.6635616461296463),
                                    ("integer (numeric)day (grain)", -3.3758795736778655),
                                    ("integer (0..19)second (grain) ", -3.6635616461296463),
                                    ("integer (0..19)hour (grain)", -3.6635616461296463),
                                    ("second", -3.152736022363656),
                                    ("integer (numeric)second (grain) ", -3.6635616461296463),
                                    ("integer (numeric)year (grain)", -3.6635616461296463),
                                    ("day", -2.816263785742443), ("quarter", -4.069026754237811),
                                    ("year", -3.152736022363656),
                                    ("integer (numeric)week (grain)", -2.68273239311792),
                                    ("integer (0..19)month (grain)", -3.6635616461296463),
                                    ("hour", -2.0541237336955462), ("month", -3.152736022363656),
                                    ("integer (numeric)minute (grain)", -3.6635616461296463),
                                    ("integer (0..19)minute (grain)", -3.6635616461296463),
                                    ("integer (numeric)month (grain)", -3.6635616461296463),
                                    ("minute", -3.152736022363656),
                                    ("integer (numeric)hour (grain)", -2.1972245773362196),
                                    ("integer (0..19)day (grain)", -3.3758795736778655),
                                    ("integer (0..19)week (grain)", -3.3758795736778655),
                                    ("integer (0..19)quarter (grain)", -4.069026754237811)],
                               n = 47}}),
       ("hhmm (latent)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
       ...
       ("last|next|following|coming n <cycle> 2",
        Classifier{okData =
                     ClassData{prior = -0.723918839226699, unseen = -3.9889840465642745,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.583997552432231),
                                    ("integer (0..19)year (grain)", -3.2771447329921766),
                                    ("integer (numeric)day (grain)", -2.871679624884012),
                                    ("integer (0..19)second (grain) ", -3.2771447329921766),
                                    ("integer (0..19)hour (grain)", -3.2771447329921766),
                                    ...
                                    ("integer (0..19)month (grain)", -3.2771447329921766),
                                    ...
                                    ("integer (0..19)day (grain)", -3.2771447329921766),
                                    ("integer (0..19)week (grain)", -3.2771447329921766)],
                               n = 16},
                   koData =
                     ClassData{prior = -0.6632942174102642, unseen = -4.02535169073515,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.3978952727983707),
                                    ("integer (0..19)year (grain)", -3.3141860046725258),
                                    ("integer (numeric)day (grain)", -3.3141860046725258),
                                    ("integer (0..19)second (grain) ", -3.3141860046725258),
                                    ("integer (0..19)hour (grain)", -3.3141860046725258),
                                    ("second", -2.908720896564361),
                                    ("integer (numeric)second (grain) ", -3.3141860046725258),
                                    ("integer (numeric)year (grain)", -3.3141860046725258),
                                    ("day", -2.6210388241125804), ("year", -2.908720896564361),
                                    ("integer (numeric)week (grain)", -2.6210388241125804),
                                    ("integer (0..19)month (grain)", -3.3141860046725258),
                                    ("hour", -2.908720896564361), ("month", -2.908720896564361),
                                    ("integer (numeric)minute (grain)", -3.3141860046725258),
                                    ("integer (0..19)minute (grain)", -3.3141860046725258),
                                    ("integer (numeric)month (grain)", -3.3141860046725258),
                                    ("minute", -2.908720896564361),
                                    ("integer (numeric)hour (grain)", -3.3141860046725258),
                                    ("integer (0..19)day (grain)", -2.908720896564361),
                                    ("integer (0..19)week (grain)", -3.3141860046725258)],
                               n = 17}}),
       ("Thanksgiving Day",
        Classifier{okData =
