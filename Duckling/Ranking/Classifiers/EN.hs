...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.6484112867185537, unseen = -5.488937726156687,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 240},
                   koData =
                     ClassData{prior = -0.7399784802440443,
       ...
       ("quarter to|till|before <hour-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -1.791759469228055,
                               likelihoods =
                                 HashMap.fromList
                                   [("noon|midnight|EOD|end of day", -0.916290731874155),
                                    ("hour", -0.916290731874155)],
                               n = 1},
                   koData =
                     ClassData{prior = -0.6931471805599453, unseen = -1.791759469228055,
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.45482200507825693,
                               unseen = -6.395261598115449,
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.447680604895319),
                                    ("hourday", -3.995695481152261),
                                    ("dayhour", -3.0977538879463027),
                                    ("daymonth", -5.0072963928307415),
                                    ("monthday", -5.294978465282522),
                                    ("monthyear", -3.828641396489095),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.700443573390687),
                                    ("Christmasyear", -5.700443573390687),
                                    ("until <time-of-day>year", -5.700443573390687),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.700443573390687),
                                    ("houryear", -5.700443573390687),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.700443573390687),
                                    ("Marchyear", -5.294978465282522),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.294978465282522),
                                    ("intersect<time-of-day> am|pm", -5.700443573390687),
                                    ("Thursdayafter <time-of-day>", -5.0072963928307415),
                                    ("Q1234year", -5.700443573390687),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.700443573390687),
                                    ("monthhour", -5.294978465282522),
                                    ("last <day-of-week> of <time>year", -5.294978465282522),
                                    ("todayat <time-of-day>", -5.700443573390687),
                                    ("Thursday<time> timezone", -5.294978465282522),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.700443573390687),
                                    ("dayday", -3.6855405528484217),
                                    ("Thanksgiving Dayyear", -4.601831284722577),
                                    ("<time> <part-of-day>at <time-of-day>", -5.700443573390687),
                                    ("Tuesdayin <named-month>", -5.700443573390687),
                                    ("mm/ddat <time-of-day>", -5.700443573390687),
                                    ("tonightat <time-of-day>", -5.700443573390687),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -5.0072963928307415),
                                    ("today<time-of-day> am|pm", -5.700443573390687),
                                    ("Februarythe <day-of-month> (ordinal)", -5.294978465282522),
                                    ("at <time-of-day><time> <part-of-day>", -5.700443573390687),
                                    ("mm/dd<time-of-day> am|pm", -5.700443573390687),
                                    ("hourhour", -4.447680604895319),
                                    ("<time-of-day> am|pmon <date>", -3.6855405528484217),
                                    ("Wednesdaythis|last|next <cycle>", -5.700443573390687),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.196366176614412),
                                    ("the <ordinal> <cycle> of <time>year", -5.700443573390687),
                                    ("dayyear", -2.501770455840005),
                                    ("last weekend of <named-month>year", -5.700443573390687),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.700443573390687),
                                    ("quarteryear", -5.700443573390687),
                                    ("<time-of-day> am|pmtomorrow", -5.0072963928307415),
                                    ("minutehour", -4.784152841516532),
                                    ("Mother's Dayyear", -5.700443573390687),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.294978465282522),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.995695481152261),
                                    ("for <duration> from <time>December", -5.700443573390687),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.700443573390687),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.784152841516532),
                                    ("Mondayin|during the <part-of-day>", -5.700443573390687),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.294978465282522),
                                    ("intersectin|during the <part-of-day>", -5.700443573390687),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.294978465282522),
                                    ("<ordinal> <cycle> of <time>year", -5.294978465282522),
                                    ("minuteday", -2.23470767059096),
                                    ("absorption of , after named dayintersect",
                                     -5.700443573390687),
                                    ("Octoberyear", -4.196366176614412),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.700443573390687),
                                    ("equal <date>year", -5.0072963928307415),
                                    ("at <time-of-day>absorption of , after named day",
                                     -5.700443573390687),
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.294978465282522),
                                    ("year<time-of-day> am|pm", -5.700443573390687),
                                    ("Septemberyear", -5.294978465282522),
                                    ("at <time-of-day>on <date>", -4.601831284722577),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -5.0072963928307415),
                                    ("in time range of <time> and <time>year", -5.700443573390687),
                                    ("Halloweenyear", -5.700443573390687),
                                    ("dayweek", -5.700443573390687),
                                    ("Thursday<time-of-day> am|pm", -5.700443573390687),
                                    ("weekyear", -4.784152841516532),
                                    ("hh:mmin|during the <part-of-day>", -5.0072963928307415),
                                    ("Father's Dayyear", -5.700443573390687),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.294978465282522),
                                    ("February<time> <part-of-day>", -5.700443573390687),
                                    ("Martin Luther King's Dayyear", -5.294978465282522),
                                    ("yearquarter", -5.700443573390687),
                                    ("tomorrowat <time-of-day>", -5.0072963928307415),
                                    ("between <time> and <time>on <date>", -5.0072963928307415),
                                    ("at <time-of-day>tomorrow", -5.294978465282522),
                                    ("tomorrow<time-of-day> am|pm", -5.700443573390687),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.700443573390687),
                                    ("black fridayyear", -5.294978465282522),
                                    ("Labor Dayyear", -5.700443573390687),
                                    ("after <time-of-day>year", -5.0072963928307415),
                                    ("Februaryintersect", -5.700443573390687),
                                    ("last <cycle> of <time>year", -4.784152841516532),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -3.5603774098944156),
                                    ("yearminute", -5.700443573390687)],
                               n = 224},
                   koData =
                     ClassData{prior = -1.0066556525716246, unseen = -6.013715156042802,
                               likelihoods =
                                 HashMap.fromList
                                   [("after <time-of-day>July", -5.318119993844216),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.219507705176107),
                                    ("Thursdayafter <time-of-day>", -3.708682081410116),
                                    ("at <time-of-day>last <time>", -5.318119993844216),
                                    ("Tuesdayafter <time-of-day>", -4.912654885736052),
                                    ...
                                    ("dayquarter", -5.318119993844216),
                                    ("mm/ddat <time-of-day>", -4.912654885736052),
                                    ("hourhour", -5.318119993844216),
                                    ("<time-of-day> am|pmon <date>", -4.065357025348848),
                                    ("dayyear", -3.6133719016057912),
                                    ("Thursdaymm/dd", -5.318119993844216),
                                    ("Thursdayat <time-of-day>", -5.318119993844216),
                                    ...
                                    ("after <time-of-day>on <date>", -4.401829261970061),
                                    ("the <day-of-month> (ordinal)<cycle> <num> <yearNum>",
                                     -5.318119993844216),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.318119993844216),
                                    ("dayminute", -2.920224721045846),
                                    ("Sundayafter <time-of-day>", -4.912654885736052),
                                    ...
                                    ("after <time-of-day><time-of-day> am|pm", -4.912654885736052),
                                    ("after <time-of-day>year", -4.624972813284271),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.318119993844216),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.2823823856765264),
                                    ("quarterhour", -2.793208009442517),
                                    ("month (grain)", -2.505525936990736),
                                    ("yearyear", -3.1986731175506815),
                                    ("week (grain)<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -2.793208009442517),
                                    ("week (grain)", -2.2823823856765264),
                                    ("weekmonth", -2.793208009442517),
                                    ("week (grain)October", -2.793208009442517),
                                    ("year (grain)year", -3.1986731175506815),
                                    ("week (grain)<named-month> <day-of-month> (non ordinal)",
                                     -2.793208009442517),
                                    ("month", -2.505525936990736), ("weekday", -2.2823823856765264),
                                    ("quarter (grain)time-of-day (latent)", -2.793208009442517)],
                               n = 16},
                   koData =
                     ClassData{prior = -2.1972245773362196,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("monthhour", -2.3513752571634776),
                                    ("week (grain)time-of-day (latent)", -2.3513752571634776),
                                    ("weekhour", -2.3513752571634776),
                                    ("month (grain)time-of-day (latent)", -2.3513752571634776)],
                               n = 2}}),
       ("number.number hours",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.0986122886681098,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.7191000372887952),
                                    ...
                                    ("integer (0..19)week (grain)", -3.41224721784874)],
                               n = 35},
                   koData =
       ...
       ("this|last|next <cycle>",
        Classifier{okData =
                     ClassData{prior = -0.2578291093020998, unseen = -4.727387818712341,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 51},
                   koData =
                     ClassData{prior = -1.4816045409242156, unseen = -3.713572066704308,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.8971199848858813),
                                    ("year (grain)", -1.6094379124341003),
                                    ("week (grain)", -1.8971199848858813),
                                    ("day", -2.3025850929940455), ("year", -1.6094379124341003),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -1.6094379124341003),
                                    ...
                                    ("<cycle> <num> <yearNum>", -1.3862943611198906),
       ...
       ("time-of-day (latent)",
        Classifier{okData =
                     ClassData{prior = -0.5389965007326869, unseen = -4.189654742026425,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)", -0.11394425934921772),
                                    ("integer (0..19)", -2.228477120840324)],
                               n = 63},
                   koData =
                     ClassData{prior = -0.8754687373538999, unseen = -3.871201010907891,
                               likelihoods =
                                 HashMap.fromList [("integer (numeric)", -2.150620522096362e-2)],
                               n = 45}}),
       ("year",
        Classifier{okData =
                     ClassData{prior = -9.844007281325252e-2, unseen = -4.0943445622221,
                               likelihoods = HashMap.fromList [("integer (numeric)", 0.0)],
                               n = 58},
                   koData =
                     ClassData{prior = -2.367123614131617, unseen = -2.0794415416798357,
                               likelihoods = HashMap.fromList [("integer (numeric)", 0.0)],
                               n = 6}}),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.81377516834856, unseen = -4.624972813284271,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.41789593950504),
                                    ("integer (0..19)year (grain)", -3.228826155721369),
                                    ("integer (numeric)day (grain)", -2.41789593950504),
                                    ("integer (0..19)second (grain) ", -3.9219733362813143),
                                    ("integer (0..19)hour (grain)", -2.8233610476132043),
                                    ("second", -3.9219733362813143),
                                    ("integer (numeric)year (grain)", -3.9219733362813143),
                                    ("day", -2.41789593950504), ("year", -3.005682604407159),
                                    ("integer (numeric)week (grain)", -3.005682604407159),
                                    ("integer (0..19)month (grain)", -3.5165082281731497),
                                    ("hour", -2.5356789751614235), ("month", -3.5165082281731497),
                                    ("integer (numeric)minute (grain)", -3.005682604407159),
                                    ("integer (0..19)minute (grain)", -2.8233610476132043),
                                    ("minute", -2.312535423847214),
                                    ("integer (numeric)hour (grain)", -3.5165082281731497),
                                    ("integer (0..19)week (grain)", -3.005682604407159)],
                               n = 39},
                   koData =
                     ClassData{prior = -0.58551651636758, unseen = -4.804021044733257,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.5985659682605218),
                                    ("integer (0..19)year (grain)", -3.6971782569286313),
                                    ("integer (numeric)day (grain)", -3.004031076368686),
                                    ("integer (0..19)second (grain) ", -3.6971782569286313),
                                    ("integer (0..19)hour (grain)", -3.6971782569286313),
                                    ("second", -2.849880396541428),
                                    ("integer (numeric)second (grain) ", -3.186352633162641),
                                    ("integer (numeric)year (grain)", -3.6971782569286313),
                                    ("day", -2.5985659682605218), ("quarter", -4.102643365036796),
                                    ("year", -3.186352633162641),
                                    ("integer (numeric)week (grain)", -3.004031076368686),
                                    ("integer (0..19)month (grain)", -3.6971782569286313),
                                    ("hour", -2.087740344494531), ("month", -3.186352633162641),
                                    ("integer (numeric)minute (grain)", -3.6971782569286313),
                                    ("integer (0..19)minute (grain)", -3.6971782569286313),
                                    ("integer (numeric)month (grain)", -3.6971782569286313),
                                    ("minute", -3.186352633162641),
                                    ("integer (numeric)hour (grain)", -2.230841188135204),
                                    ("integer (0..19)day (grain)", -3.4094961844768505),
                                    ("integer (0..19)week (grain)", -3.4094961844768505),
                                    ("integer (0..19)quarter (grain)", -4.102643365036796)],
                               n = 49}}),
       ("hhmm (latent)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
       ...
       ("last|next|following|coming n <cycle> 2",
        Classifier{okData =
                     ClassData{prior = -8.223809823697212e-2,
                               ...
                               n = 35},
                   koData =
                     ClassData{prior = -2.538973871058276, unseen = -3.332204510175204,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)day (grain)", -2.1972245773362196),
                                    ("second", -2.6026896854443837),
                                    ("integer (numeric)second (grain) ", -2.6026896854443837),
       ...
       (" year Q1/2/3/4 ",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.3862943611198906,
                               likelihoods = HashMap.fromList [("year", 0.0)], n = 2},
                   koData =
                     ClassData{prior = -infinity, unseen = -0.6931471805599453,
                               likelihoods = HashMap.fromList [], n = 0}}),
       ("intersect by \",\", \"of\", \"from\", \"'s\"",
       ...
       ("<cycle> <num> <yearNum>",
        Classifier{okData =
                     ClassData{prior = -0.39465419200394874,
                               unseen = -4.304065093204169,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.498699971920336),
                                    ("quarter (grain)integer (numeric)", -1.8055527913603908),
                                    ("quarter", -1.7255100836868544), ("year", -2.211017899468555),
                                    ("week (grain)integer (numeric)", -2.498699971920336),
                                    ("month", -2.211017899468555),
                                    ("quarter (grain)integer (numeric)integer (numeric)",
                                     -3.597312260588446),
                                    ("month (grain)integer (numeric)", -2.211017899468555),
                                    ("year (grain)integer (numeric)", -2.211017899468555)],
                               n = 31},
                   koData =
                     ClassData{prior = -1.120591195386885, unseen = -3.7376696182833684,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.6149597780361984),
                                    ("day (grain)integer (numeric)", -1.7676619176489945),
                                    ("quarter (grain)integer (numeric)", -1.6341305250244718),
                                    ("day", -1.7676619176489945), ("quarter", -1.6341305250244718),
                                    ("week (grain)integer (numeric)", -2.6149597780361984)],
                               n = 15}}),
       ("last <time>",
        Classifier{okData =
       ...
       ("until <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -0.579818495252942, unseen = -3.8066624897703196,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.174751721484161), ("January", -3.0910424533583156),
                                    ("intersect", -3.0910424533583156),
                                    ("now", -3.0910424533583156), ("day", -2.6855773452501515),
                                    ("time-of-day (latent)", -3.0910424533583156),
                                    ("<time-of-day> am|pm", -2.3978952727983707),
                                    ("hh:mm", -2.6855773452501515),
                                    ("nograin", -3.0910424533583156),
                                    ("<cycle> <num> <yearNum>", -2.174751721484161),
                                    ("hour", -2.6855773452501515), ("month", -3.0910424533583156),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -3.0910424533583156),
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.9444389791664407),
                                    ...
                                    ("the <cycle> of <time>", -2.9444389791664407),
                                    ("yesterday", -2.538973871058276), ("day", -2.538973871058276),
                                    ("hh:mm", -2.0281482472922856), ("hour", -2.9444389791664407),
       ...
       ("after <time-of-day>",
        Classifier{okData =
                     ClassData{prior = -1.0775588794702773, unseen = -4.564348191467836,
                               likelihoods =
                                 HashMap.fromList
                                   [("January", -3.1675825304806504), ("July", -3.8607297110405954),
                                    ("intersect", -3.1675825304806504),
                                    ("the <cycle> of <time>", -3.455264602932431),
                                    ("day", -2.6079667425452278), ("quarter", -2.0689702418125404),
                                    ("time-of-day (latent)", -3.1675825304806504),
                                    ("<time-of-day> am|pm", -3.1675825304806504),
                                    ("hh:mm", -2.9444389791664407),
                                    ("<cycle> <num> <yearNum>", -2.2512917986064953),
                                    ("hour", -2.6079667425452278), ("month", -2.762117422372486),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -3.1675825304806504),
                                    ("minute", -2.9444389791664407),
                                    ("August", -3.8607297110405954)],
                               n = 32},
                   koData =
                     ClassData{prior = -0.41616039722491244,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> to|till|before <hour-of-day>", -3.9448128282511368),
                                    ("week", -3.9448128282511368),
                                    ("<day-of-month> (ordinal or number) <named-month>",
                                     -4.350277936359301),
                                    ("today", -4.350277936359301), ("January", -4.350277936359301),
                                    ("intersect", -2.645529844120876),
                                    ("second", -4.350277936359301), ("now", -3.657130755799356),
                                    ("tomorrow", -3.4339872044851463),
                                    ("this|last|next <cycle>", -3.9448128282511368),
                                    ("day", -1.865371286571301),
                                    ("time-of-day (latent)", -3.9448128282511368),
                                    ("<time-of-day> am|pm", -3.657130755799356),
                                    ("hh:mm", -4.350277936359301), ("nograin", -3.657130755799356),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)",
                                     -4.350277936359301),
                                    ("Christmas", -3.2516656476911914),
                                    ("hour", -2.740840023925201), ("month", -4.350277936359301),
                                    ("<datetime> - <datetime> (interval)", -2.9639835752394106),
                                    ("<time-of-day> - <time-of-day> (interval)",
                                     -2.645529844120876),
                                    ("<named-month> <day-of-month> (non ordinal)",
                                     -3.657130755799356),
                                    ("minute", -1.865371286571301),
                                    ("right now", -4.350277936359301),
                                    ("<month> dd-dd (interval)", -3.657130755799356),
                                    ("dd-dd <month> (interval)", -3.9448128282511368)],
                               n = 62}}),
       ("day (grain)",
        Classifier{okData =
                     ClassData{prior = -0.1941560144409575,
                     ...
                     ClassData{prior = -0.5108256237659907, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("<integer> <unit-of-duration><day-of-month> (ordinal)",
                                     -1.8718021769015913),
                                    ("dayday", -1.466337068793427), ("day", -1.8718021769015913),
                                    ("<integer> <unit-of-duration>", -1.8718021769015913),
                                    ("<integer> <unit-of-duration><day-of-month> (ordinal or number) <named-month>",
                                     -1.8718021769015913)],
                               n = 3},
                   koData =
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("dayhour", -1.7047480922384253),
                                    ...
                                    ("<integer> <unit-of-duration>", -1.7047480922384253)],
                               n = 2}}),
