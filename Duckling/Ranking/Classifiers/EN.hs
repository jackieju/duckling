...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.7024495732222589, unseen = -5.375278407684165,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 214},
                   koData =
                     ClassData{prior = -0.6839305254550213, unseen = -5.393627546352362,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("<datetime> - <datetime> (interval)on <date>",
                                    ...
                                    ("monthyear", -3.8252913096038133),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.697093486505405),
                                    ("Christmasyear", -5.697093486505405),
                                    ("until <time-of-day>year", -5.697093486505405),
                                    ("from <datetime> - <datetime> (interval)July",
                                     -5.697093486505405),
                                    ("houryear", -5.697093486505405),
                                    ...
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -4.19301608972913),
                                    ("the <ordinal> <cycle> of <time>year", -5.697093486505405),
                                    ("dayyear", -2.498420368954723),
                                    ("last weekend of <named-month>year", -5.697093486505405),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.697093486505405),
                                    ("quarteryear", -5.697093486505405),
                                    ...
                                    ("<time-of-day> - <time-of-day> (interval)tomorrow",
                                     -5.697093486505405),
                                    ("yearQ1234", -5.697093486505405),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.697093486505405),
                                    ("dayminute", -3.132144129043868),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.29162837839724),
                                    ("<ordinal> <cycle> of <time>year", -5.29162837839724),
                                    ("minuteday", -2.231357583705678),
                                    ("absorption of , after named dayintersect",
                                     -5.697093486505405),
                                    ("Octoberyear", -4.19301608972913),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.697093486505405),
                                    ("equal <date>year", -5.003946305945459),
                                    ...
                                    ("after <time-of-day>year", -5.003946305945459),
                                    ("Februaryintersect", -5.697093486505405),
                                    ("last <cycle> of <time>year", -4.7808027546312495),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -3.557027323009134),
                                    ("yearminute", -5.697093486505405)],
                               n = 224},
                   koData =
                     ClassData{prior = -1.0116009116784799, unseen = -6.003887067106539,
                               likelihoods =
                                 HashMap.fromList
                                   [("after <time-of-day>July", -5.308267697401205),
                                    ...
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.209655408733095),
                                    ("Thursdayafter <time-of-day>", -3.698829784967104),
                                    ("at <time-of-day>last <time>", -5.308267697401205),
                                    ("Tuesdayafter <time-of-day>", -4.9028025892930405),
                                    ...
                                    ("after <time-of-day>on <date>", -4.39197696552705),
                                    ...
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.308267697401205),
                                    ("dayminute", -2.9103724246028344),
                                    ("Sundayafter <time-of-day>", -4.9028025892930405),
                                    ...
                                    ("after <time-of-day><time-of-day> am|pm", -4.9028025892930405),
                                    ("after <time-of-day>year", -4.61512051684126),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.308267697401205),
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.8283219589281979, unseen = -4.605170185988091,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 38},
                   koData =
                     ClassData{prior = -0.5740878205439571, unseen = -4.804021044733257,
                               likelihoods =
                                 HashMap.fromList
